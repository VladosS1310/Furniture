...
class AddToWishlist implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function getFinalData($data, $additionalData, $addedData, $parentQty = 1)
    {
        ...
        // Add content_ids param
        $customData = $data['data'][0]['custom_data'];
        $data['data'][0]['custom_data'] = $this->helper->addContentIdsParam($customData);
     ...
     * @param \Magento\Quote\Model\Quote $items
     * @param int $detect
     * @return array
     */
    public function getEventDataForProduct($product, $items, $detect = 0)
    {
        ...
        // Add content_ids param
        $customData = $finalData['data'][0]['custom_data'];
        $finalData['data'][0]['custom_data'] = $this->helper->addContentIdsParam($customData);
     ...
     * @return \Apptrian\MetaPixelApi\Observer\AddToWishlist
     */
